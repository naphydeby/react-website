    ...
    <>
      ...
      <div className={`lg:flex`}>
        ...
        <div className={`mt-10 lg:mr-10 ml-10 lg:ml-0 `}>
          ...
          <hr className={`mt-2 w-[80px] font-bold border-gray-600 border-4`} />
          <div
            className={`mt-10 w-[50vw] lg:w-[30vw] h-auto  border-gray-600 border-4 text-gray-600 `}
          >
          ...
          <div
            className={`mt-2  w-[50vw] lg:w-[30vw] h-auto  border-gray-600 border-4 text-gray-600 `}
          >
