...
import school from '../assets/images/school-building.jpg'
  ...
  return (
    <>
     ...
     <div className='w-[100%] flex flex-col '>
      {/* bgimg */}
       <div style={bgdiv} >
  <img src={school} className="w-full h-auto " />
   <p className="font-bold lg:text-2xl text-gray-400 ml-4">About Us</p>
   </div>
     {/* intro and mission  */}
   <div className="lg:flex justify-between">
<div className="mt-10 ml-10 text-gray-600">
  <h2 className="font-sm text-2xl lg:text-4xl">Introduction</h2>
...
<div className="mt-10 lg:mr-10 ml-10 lg:ml-0">
...
<div className="flex mt-12">
  <div className=" w-[35vw] lg:w-[30vw] border-8 border-gray-600">
    <img src={logo1} />
  </div>
  <div className="w-[35vw] lg:w-[30vw] border-8 border-gray-600 ml-8">
